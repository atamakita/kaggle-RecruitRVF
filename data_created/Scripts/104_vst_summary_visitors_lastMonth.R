...
df.air_vst <- lst.data[["air_vst"]] %>% 
  ...
  dplyr::summarise(max_vst_lastmonth = max(visitors, na.rm=T), 
                   min_vst_lastmonth = min(visitors, na.rm=T),
                   mean_vst_lastmonth = mean(visitors, na.rm=T), 
  ...
  dplyr::group_by(air_store_id) %>% 
  tidyr::fill(max_vst_lastmonth, min_vst_lastmonth, mean_vst_lastmonth, med_vst_lastmonth, cnt_vst_lastmonth) %>% 
  tidyr::fill(max_vst_lastmonth, min_vst_lastmonth, mean_vst_lastmonth, med_vst_lastmonth, cnt_vst_lastmonth, .direction = "up") %>% 
  dplyr::ungroup()
